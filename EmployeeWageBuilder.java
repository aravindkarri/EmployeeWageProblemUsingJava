...
public class EmployeeWageBuilder {
	...
	public static void main(String args[]) {
		...
		wageBuilder.addCompanyEmployeeWage("Bridgelabz",20,20,100);
		wageBuilder.addCompanyEmployeeWage("Dmart",15,25,200);
		wageBuilder.addCompanyEmployeeWage("Reliance",20,30,100);
